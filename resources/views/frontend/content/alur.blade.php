        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="flow-box wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                    <div class="flow-img">
                        <img src="{{asset('Assets/Frontend/img/alur/step1.jpg')}}" alt="Registrasi Online">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="flow-box wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                    <div class="flow-img">
                        <img src="{{asset('Assets/Frontend/img/alur/step2.jpg')}}" alt="Upload Berkas">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="flow-box wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                    <div class="flow-img">
                        <img src="{{asset('Assets/Frontend/img/alur/step3.jpg')}}" alt="Pembayaran">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="flow-box wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                    <div class="flow-img">
                        <img src="{{asset('Assets/Frontend/img/alur/step4.jpg')}}" alt="Verifikasi">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="flow-box wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                    <div class="flow-img">
                        <img src="{{asset('Assets/Frontend/img/alur/step5.jpg')}}" alt="Ujian">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="flow-box wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.7s">
                    <div class="flow-img">
                        <img src="{{asset('Assets/Frontend/img/alur/step6.jpg')}}" alt="Pengumuman">
