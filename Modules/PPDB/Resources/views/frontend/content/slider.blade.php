<div class="bend niceties preview-1">
    ...
    <div class="slider-wrapper">
        <div class="slider-slide active">
            <img src="{{asset('Assets/Frontend/img/slider/slider-ppdb.jpeg')}}" alt="slider" class="slider-image" />
        ...
        <div class="slider-slide">
            <img src="{{asset('Assets/Frontend/img/slider/slider-ppdb2.jpeg')}}" alt="slider" class="slider-image" />
            <div class="slider-overlay">
                <div class="title-container">
