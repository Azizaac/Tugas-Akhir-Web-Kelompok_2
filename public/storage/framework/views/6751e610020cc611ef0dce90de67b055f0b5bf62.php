        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action=" <?php echo e(route('backend-pengguna-pengajar.store')); ?> " method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-6">
...
unset($__errorArgs, $__bag); ?>" name="name" value=" <?php echo e(old('name')); ?> " placeholder="Nama" />
...
unset($__errorArgs, $__bag); ?>" name="nip" value=" <?php echo e(old('nip')); ?> " placeholder="NIP" />
                                        <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="website" value=" <?php echo e(old('website')); ?> " placeholder="Website" />
...
unset($__errorArgs, $__bag); ?>" name="linkedln" value=" <?php echo e(old('linkidln')); ?> " placeholder="Linkedln" />
...
unset($__errorArgs, $__bag); ?>" name="instagram" value=" <?php echo e(old('instagram')); ?> " placeholder="Instagram" />
...
unset($__errorArgs, $__bag); ?>" name="facebook" value=" <?php echo e(old('facebook')); ?> " placeholder="Facebook" />
...
unset($__errorArgs, $__bag); ?>" name="youtube" value=" <?php echo e(old('youtube')); ?> " placeholder="Youtube" />
...
unset($__errorArgs, $__bag); ?>" name="twitter" value=" <?php echo e(old('twitter')); ?> " placeholder="Twitter" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nugwttbr/public_html/resources/views/backend/pengguna/pengajar/create.blade.php ENDPATH**/ ?>