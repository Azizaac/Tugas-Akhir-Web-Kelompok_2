            ...
            <div class="col-lg-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-footer bg-light text-center py-3">
                        <button class="btn btn-primary" onclick="window.open('<?php echo e(asset('storage/images/profileSekolah/Struktur-Smkn5.png')); ?>', '_blank')">
...
<?php echo $__env->make('layouts.Frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nugwttbr/public_html/resources/views/frontend/content/profileSekolah.blade.php ENDPATH**/ ?>