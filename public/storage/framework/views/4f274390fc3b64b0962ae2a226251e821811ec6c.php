        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action=" <?php echo e(route('program-studi.store')); ?> " method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-6">
...
unset($__errorArgs, $__bag); ?>" name="nama" placeholder="Nama Program Studi" />
...
unset($__errorArgs, $__bag); ?>" name="singkatan" placeholder="Singkatan" />
...
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sekolahku\resources\views/backend/website/program/create.blade.php ENDPATH**/ ?>