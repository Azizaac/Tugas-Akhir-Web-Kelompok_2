<div class="faq-page-area">
    <div class="container">
        <h1 class="about-title">Kenapa Harus SMKN 5 Surakarta ?</h1>
                    ...
                    <div class="faq-box-item panel panel-default">
                        ...
                        <div aria-expanded="false" id="collapseOne" role="tabpanel" class="panel-collapse collapse in">
                            <div class="panel-body faq-box-body">
                                <p>SMKN 5 Surakarta telah memperoleh akreditasi A, menandakan kualitas pendidikan, fasilitas, dan manajemen sekolah yang sangat baik.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="faq-box-wrapper">
                    <div class="faq-box-item panel panel-default">
                        ...
                        <div aria-expanded="false" id="collapseTwo" role="tabpanel" class="panel-collapse collapse">
                            <div class="panel-body faq-box-body">
                                <p>Sekolah dilengkapi dengan laboratorium modern, ruang kelas nyaman, perpustakaan, fasilitas olahraga, hotspot internet, dan studio musik.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="faq-box-wrapper">
                    <div class="faq-box-item panel panel-default">
                        ...
                        <div aria-expanded="false" id="collapseThree" role="tabpanel" class="panel-collapse collapse">
                            <div class="panel-body faq-box-body">
                                <p>Guru-guru di SMKN 5 merupakan lulusan perguruan tinggi ternama di Indonesia, baik dari jenjang S1 maupun S2, menjamin mutu pembelajaran yang profesional.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="faq-box-wrapper">
                    <div class="faq-box-item panel panel-default">
                        ...
                        <div aria-expanded="false" id="collapseFour" role="tabpanel" class="panel-collapse collapse">
                            <div class="panel-body faq-box-body">
                                <p>Tersedia berbagai program beasiswa bagi siswa berprestasi maupun yang membutuhkan, baik selama sekolah maupun untuk melanjutkan kuliah.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="faq-box-wrapper">
                    <div class="faq-box-item panel panel-default">
                        ...
                        <div aria-expanded="false" id="collapseFive" role="tabpanel" class="panel-collapse collapse">
                            <div class="panel-body faq-box-body">
                                <p>Kurikulum berbasis industri dan praktik lapangan menjadikan lulusan SMKN 5 siap menghadapi dunia kerja, melanjutkan pendidikan, atau membuka usaha sendiri.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="faq-box-wrapper">
                    <div class="faq-box-item panel panel-default">
                        ...
                        <div aria-expanded="false" id="collapseSix" role="tabpanel" class="panel-collapse collapse">
                            <div class="panel-body faq-box-body">
                                <p>Sekolah ini aktif mengikuti dan memenangkan berbagai lomba tingkat kota, provinsi, hingga nasional.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
</div><?php /**PATH /home/nugwttbr/public_html/Modules/PPDB/Resources/views/frontend/content/why.blade.php ENDPATH**/ ?>