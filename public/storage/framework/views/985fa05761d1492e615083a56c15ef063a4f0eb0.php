                            ...
                            <div class="news-box shadow-sm border rounded">
                                <div class="news-img-holder">
                                    <a href="<?php echo e(route('detail.berita', $beritas->slug)); ?>">
                                        <img src="<?php echo e(asset('storage/images/berita/' . $beritas->thumbnail)); ?>"
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="latest-research-img">
                                            <a href="<?php echo e(route('detail.berita', $beritas->slug)); ?>">
                                                <img src="<?php echo e(asset('storage/images/berita/' . $beritas->thumbnail)); ?>" class="img-responsive" alt="Berita">
                                            </a>
                                        </div>
...
<?php echo $__env->make('layouts.Frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sekolahku\resources\views/frontend/content/beritaAll.blade.php ENDPATH**/ ?>